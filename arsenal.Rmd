...
```{r results='asis'}
tb <- tableby(arm ~ fe(sex, digits.pct = 0) + notest(age, digits = 1, "median", "q1q3"), data = mockstudy)
...
Stratified, subsetted, and multiple endpoint summary:
...
This presentation: https://github.com/eheinzen/2021_arsenal_RMedicine
